...
| 6 | [Quint specification with redelegation](https://github.com/informalsystems/partnership-heliax/tree/trunk/2023/Q3/artifacts/PoS-quint) | Ongoing | manuel/quint-redelegation | Pending: (i) deterministic iteration over validator's addresses; and (ii) slashing destination validators after the pipeline offset|
